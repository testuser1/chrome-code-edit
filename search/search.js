...
(function() {
  ...
  function confirmDialog(cm, text, shortText, fs, options) {
      ...
      cm.operation(function() {
        ...
        clearSearch(cm);
          ...
          function advance(rev) {
            ...
            confirmDialog(cm, aftersDialog, "Next",
                          [function() {advance();}, function() {advance(true);}],{bottom:true});
          }
          advance();
      });
    }, {bottom:true});
